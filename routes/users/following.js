...
var following = require(rootPath+"/controllers/following");
...
/*
    ...
    unfollows 
*/
console.log("/idUser/following : START");
router.route("/")
.get(routeIdFollowed, auth.readToken, following.getAllFollowing)
...
.put(routeIdFollowed, auth.readToken, following.addFollowing);
console.log("/idUser/following : OK");
